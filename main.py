...
def draw_number_card(deck):
    # Draw cards from the deck until you get a number card
    while deck:
        card = deck.pop()
...
def process_hand(hand, deck):
    ...
    # Include square roots and multiplication cards
    ...
    # Discard another symbol for multiplication card
...
# Use recursion to return best solutions
...
# Find closest to target equations
...
expressions = generate_expressions(hand)
best_results = find_best_results(expressions)
